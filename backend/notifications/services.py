...
TYPE_CATEGORY = {
    ...
    Notification.NotificationType.SCORING_MATCH_REQUEST_RECEIVED: Notification.Category.MATCHES,
    Notification.NotificationType.SCORING_MATCH_REQUEST_ACCEPTED: Notification.Category.MATCHES,
    Notification.NotificationType.SCORING_MATCH_REQUEST_DECLINED: Notification.Category.MATCHES,
...
def notification_allowed_for_recipient(recipient, notification_type):
    ...
    preference_map = {
        ...
        Notification.NotificationType.SCORING_MATCH_REQUEST_RECEIVED: "notify_team_challenges",
        Notification.NotificationType.SCORING_MATCH_REQUEST_ACCEPTED: "notify_team_challenges",
        Notification.NotificationType.SCORING_MATCH_REQUEST_DECLINED: "notify_team_challenges",
