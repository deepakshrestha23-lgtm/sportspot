...
class Notification(models.Model):
    class NotificationType(models.TextChoices):
        ...
        SCORING_MATCH_REQUEST_RECEIVED = "SCORING_MATCH_REQUEST_RECEIVED", "Scoring Match Request Received"
        SCORING_MATCH_REQUEST_ACCEPTED = "SCORING_MATCH_REQUEST_ACCEPTED", "Scoring Match Request Accepted"
        SCORING_MATCH_REQUEST_DECLINED = "SCORING_MATCH_REQUEST_DECLINED", "Scoring Match Request Declined"
