...
from .views import (
    ...
    GameParticipantAttendanceView,
    GameParticipantAttendanceDisputeView,
    GameReconfirmView,
...
urlpatterns = [
    ...
    path("games/<int:game_id>/participants/<int:participant_id>/attendance/", GameParticipantAttendanceView.as_view(), name="matchmaking-game-participant-attendance"),
    path("games/<int:game_id>/participants/<int:participant_id>/attendance/dispute/", GameParticipantAttendanceDisputeView.as_view(), name="matchmaking-game-participant-attendance-dispute"),
    ...
    path("games/<int:game_id>/chat/", GameChatView.as_view(), name="matchmaking-game-chat"),
    path("games/<int:game_id>/chat/<int:message_id>/", GameChatMessageDetailView.as_view(), name="matchmaking-game-chat-message"),
