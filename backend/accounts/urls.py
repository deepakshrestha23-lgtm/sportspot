...
from .views import (
    ...
    OwnerNotificationSettingsUpdateView,
    OwnerSettingsView,
    PasswordChangeView,
...
urlpatterns = [
    ...
    path("settings/owner/", OwnerSettingsView.as_view(), name="auth-owner-settings"),
    ...
    path("settings/owner/notifications/", OwnerNotificationSettingsUpdateView.as_view(), name="auth-owner-settings-notifications"),
