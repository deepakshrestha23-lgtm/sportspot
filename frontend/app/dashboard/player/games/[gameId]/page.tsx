      ...
      <section className="grid items-start gap-5 xl:grid-cols-3">
        <div className="min-w-0 space-y-5 xl:col-span-2">
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <section className="min-w-0 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"><div className="flex items-center justify-between gap-3"><h2 className="text-xl font-black text-sportNavy">Join requests</h2><Badge>{pendingRequests.length} pending</Badge></div><RequestList requests={pendingRequests} empty="No pending requests." onDecision={decide} disabled={actionInProgress} /></section>
            <section className="min-w-0 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"><div className="flex items-center justify-between gap-3"><h2 className="text-xl font-black text-sportNavy">Waitlist</h2><Badge tone="blue">{waitlistedRequests.length} players</Badge></div><RequestList requests={waitlistedRequests} empty="No waitlisted players." onDecision={decide} disabled={actionInProgress} /></section>
          </div>
